...
public class SpigotServerFactory {
    ...
    public static SpigotServer createServer(Plugin plugin) {
        ...
        switch (version) {
            ...
            case "v1_12_R1":
                return new V1_12R1SpigotServer(plugin);
            case "v1_13_R2":
                return new V1_13R2SpigotServer(plugin);
            case "v1_14_R1":
                return new V1_14R1SpigotServer(plugin);
            case "v1_15_R1":
            case "v1_16_R3":
            case "v1_17_R1":
            case "v1_18_R2":
